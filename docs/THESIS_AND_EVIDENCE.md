...
| T4 | A one-line hint carries most of the surprisal collapse (hint-dose curve) | — | **Untested.** E has no dedicated receipt; the hint-dose design is specified in RESEARCH_FOUNDATIONS.md test 3 |
...
ceiling**. Sources: the receipt named beside each row above.
