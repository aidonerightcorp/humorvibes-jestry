...
REPO_REF = "humor-genome-wave2-v7"
...
CELLS: list[tuple[str, str]] = [
    ...
    ("markdown",
     ...
     "labels with contest-held-out splits. |\n"
     ...
     "- Immutable source for this run: `humor-genome-wave2-v7`\n\n"
    ...
    ("markdown",
     ...
     "program, not a completed causal theory: Wave 2 directly measures S, organizes evidence for "
     "R/E/B, and reports where the available data cannot decide the broader claim."),
